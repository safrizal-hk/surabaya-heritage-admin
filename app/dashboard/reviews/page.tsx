...
export default function ReviewsListPage() {
  const { reviews, places, users, deleteReview } = useDB();
  ...
  const handleDeleteConfirm = () => {
    if (deleteConfirmId !== null) {
      const success = deleteReview(deleteConfirmId);
      if (success) {
        toast({
  ...
  return (
    <div className="w-full min-w-0 space-y-6 max-w-7xl mx-auto">
      {/* Header section */}
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-zinc-950">Review Moderation</h1>
