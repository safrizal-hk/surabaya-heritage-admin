...
export default function DashboardPage() {
  const { places, categories, users, reviews, placePhotos } = useDB();
          ...
          <div className="space-y-4">
            {recentReviews.length > 0 ? (
              recentReviews.map((review) => {
                ...
                return (
                  <div key={review.id} className="flex gap-3 text-xs border-b border-zinc-100 pb-3 last:border-0 last:pb-0">
