  ...
  >
    <div className="w-full max-w-md">
      ...
      <div className="flex flex-col items-center mb-8 gap-2">
        ...
        >
          <Landmark className="h-7 w-7" style={{ color: "#1B3A6B" }} />
        </div>
        <h1 className="text-2xl font-bold tracking-tight text-white mt-2">
          Surabaya Heritage
        </h1>
        <p className="text-sm font-medium" style={{ color: "#F5E6C8", opacity: 0.8 }}>
      ...
      <Card className="border-0 shadow-xl bg-white">
        <CardHeader className="pb-4">
          <CardTitle className="text-xl font-semibold" style={{ color: "#1B3A6B" }}>
            Sign In
          </CardTitle>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            {error && (
              <div className="flex items-center gap-2 text-xs font-semibold text-destructive bg-destructive/10 border border-destructive/20 p-3 rounded-md">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider" style={{ color: "#1B3A6B" }}>
                Email Address
              </label>
          ...
          <CardFooter className="flex flex-col gap-4">
            <Button
              type="submit"
              className="w-full h-10 font-medium cursor-pointer text-white"
