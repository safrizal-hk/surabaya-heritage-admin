...
import { Landmark, ArrowLeft, Save, MapPin, Clock, Phone, Info } from "lucide-react";
...
export default function PlaceCreateForm({
  ...
  const { categories: contextCategories, createPlace, addPhoto } = useDB();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (photoUrl.trim()) {
        await addPhoto(newPlace.id, photoUrl.trim(), photoCaption.trim() || "Primary Photo", true);
      } else {
        await addPhoto(
          newPlace.id,
