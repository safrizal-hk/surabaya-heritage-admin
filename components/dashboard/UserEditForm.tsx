...
export default function UserEditForm({
  ...
  // Find user from context first (for reactive edits), fallback to server initialUser
  const userFromContext = users.find((u) => u.id === userId);
  const user = userFromContext || initialUser;
